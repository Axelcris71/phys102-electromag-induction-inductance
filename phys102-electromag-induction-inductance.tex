...
\begin{document}
	\noindent
	SULADAY, Axelcris G. \hfill PHYS102: Electromagnetic Induction and Inductance
	\rule{\textwidth}{1px}
	\begin{center}
	...
	\begin{hangparas}{65pt}{1}
		\textbf{Example 4:} An airplane with a wingspan of 30.0 m flies due north at a location where the downward component of the Earth's magnetic field of \(0.600\times10^{-4}\) T. There is also a component pointing due north which has a magnitude of \(0.470\times10^{-4}\) T.
	\end{hangparas}
